...
Интерактивный ноутбук [jupyter_demo.ipynb](jupyter_demo.ipynb) содержит живые примеры кода, демонстрирующие:
- Работу с pandas DataFrames
- Объектно-ориентированное программирование
- Фильтрацию и анализ данных
- Использование внешних библиотек (NumPy, Matplotlib)
- Обработку JSON данных и нейронных записей
- Типичные ошибки Python и как их избежать
